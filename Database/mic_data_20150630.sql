-- 29150630 Changes:
-- Add new column mic_customer.is_default_password
-- Add new columns mic_payment.start_date and mic_payment.expired_date
-- Add new column last_modified into mic_contract, mic_customer, mic_compensation, mic_accident, mic_punishment
