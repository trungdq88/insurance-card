...
INSERT INTO `increments` VALUES ('BT',2),('HD',44),('KH',40),('NV',9);
...
) ENGINE=InnoDB AUTO_INCREMENT=71 DEFAULT CHARSET=utf8 COMMENT='Card information';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `mic_notification_read` VALUES (77,'NV0001',38,1),(78,'NV0001',39,1),(79,'NV0001',40,1),(80,'NV0001',47,1),(81,'NV0001',46,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=148 DEFAULT CHARSET=utf8 COMMENT='Payment information';
/*!40101 SET character_set_client = @saved_cs_client */;
...
ALTER TABLE `mic_data`.`mic_compensation` 
CHANGE COLUMN `driver_name` `driver_name` VARCHAR(80) NULL ,
CHANGE COLUMN `license_number` `license_number` VARCHAR(15) NULL ,
CHANGE COLUMN `license_type` `license_type` VARCHAR(10) NULL ,
CHANGE COLUMN `driver_phone` `driver_phone` VARCHAR(15) NULL ,
CHANGE COLUMN `vehicle_capacity` `vehicle_capacity` VARCHAR(20) NULL ,
CHANGE COLUMN `driver_address` `driver_address` VARCHAR(250) NULL ,
CHANGE COLUMN `plate` `plate` VARCHAR(15) NULL ,
CHANGE COLUMN `accident_date` `accident_date` DATETIME NULL ,
CHANGE COLUMN `accident_place` `accident_place` VARCHAR(250) NULL ,
CHANGE COLUMN `control_department` `control_department` VARCHAR(250) NULL ,
CHANGE COLUMN `description` `description` VARCHAR(2000) NULL ,
CHANGE COLUMN `human_damage` `human_damage` VARCHAR(2000) NULL ,
CHANGE COLUMN `asset_damage` `asset_damage` VARCHAR(2000) NULL ,
CHANGE COLUMN `observer` `observer` VARCHAR(80) NULL ,
CHANGE COLUMN `observer_address` `observer_address` VARCHAR(250) NULL ;
...
-- Dump completed on 2015-07-26 23:54:25
