  ...
  <div id="page-wrapper">
    ...
    <div class="row">
      <div class="col-lg-12">
        <form action="${pageContext.request.contextPath}/staff/customer"
          ...
          <fieldset>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <div class="text-value">
                  <input class="form-control input-md" type="text" name="customer:address" required value="${submitted.address}" maxlength="250" minlength="3">
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <label class="col-sm-2 control-label">Số CMND / Hộ chiếu</label>
        ...
        <br/>
        <div class="pull-left">
          <a href="${pageContext.request.contextPath}/staff/customer?action=detail&code=${submitted.customerCode}" type="button" class="btn btn-success">
